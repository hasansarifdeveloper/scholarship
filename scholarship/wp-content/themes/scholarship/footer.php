			...
			<div class="site-info">
				<div class="mt-container">
					<div class="scholarship-copyright-wrapper">
						<?php $scholarship_copyright_text = get_theme_mod( 'scholarship_copyright_text', __( 'Hasan', 'hasan' ) ); ?>
						<span class="scholarship-copyright"><?php echo wp_kses_post( $scholarship_copyright_text ); ?></span>
						<span class="sep"> | </span>
						<?php printf( esc_html__( '%1$s by hasan %2$s.', 'hasan' ), 'blog Theme', '<a href="'. esc_url( 'https://mysterythemes.com/' ).'" rel="designer">Hasan </a>' ); ?>
					</div>
					<?php 
